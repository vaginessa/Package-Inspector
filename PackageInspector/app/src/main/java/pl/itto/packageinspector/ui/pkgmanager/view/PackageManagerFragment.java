...
import pl.itto.packageinspector.ui.pkgmanager.data.PackageManagerDataSource;
import pl.itto.packageinspector.ui.pkgmanager.presenter.PackageManagerPresenter;
...
public class PackageManagerFragment extends Fragment implements IPackageManagerContract.IPackageManagerView {
    ...
    private IPackageManagerContract.IPackageManagerPresenter mPresenter;
    private ProgressDialog mDialog;
    private boolean mFirstRun = true;
    private IPackageManagerContract.ISearchAppsCallback mSearchCallback;
    ...
    public void setupAdapter() {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                mSearchCallback = (IPackageManagerContract.ISearchAppsCallback) mAppsPagerAdapter.getRegisteredFragment(position);
            }
    ...
    @Override
    public void setPresenter(IPackageManagerContract.IPackageManagerPresenter presenter) {
